...
class Tado:
    ...
    def __init__(
        ...
        if token_manager and (token_file_path or saved_refresh_token):
            raise ValueError("Cannot provide both token_manager and token_file_path/saved_refresh_token.")

        self._http = Http(
            http_session=http_session,
            token_manager=token_manager or PersistingTokenManager(token_file_path, saved_refresh_token),
            debug=debug,
        )
