...
def _mock_tado_climate_zone_from_fixture(filename):
    with (
        patch("PyTado.http.Http._login", return_value=(1, "foo")),
        patch("PyTado.interface.Tado.get_me"),
        patch(
...
def test_ac_issue_32294_heat_mode():
    ...
    assert (
        ac_issue_32294_heat_mode.current_temp_timestamp
    ...
    assert (
        ac_issue_32294_heat_mode.ac_power_timestamp
...
def test_smartac3_smart_mode():
    ...
    assert (
        smartac3_smart_mode.current_temp_timestamp == "2020-03-05T03:50:24.769Z"
    )
    ...
    assert (
        smartac3_smart_mode.current_humidity_timestamp
...
def test_smartac3_cool_mode():
    """Test smart ac cool mode."""
    smartac3_cool_mode = _mock_tado_climate_zone_from_fixture(
        "smartac3.cool_mode.json"
    )
    ...
    assert (
        smartac3_cool_mode.current_temp_timestamp == "2020-03-05T03:57:38.850Z"
    )
    ...
    assert (
        smartac3_cool_mode.current_humidity_timestamp
...
def test_smartac3_auto_mode():
    """Test smart ac cool mode."""
    smartac3_auto_mode = _mock_tado_climate_zone_from_fixture(
        "smartac3.auto_mode.json"
    )
    ...
    assert (
        smartac3_auto_mode.current_temp_timestamp == "2020-03-05T03:55:38.160Z"
    )
    ...
    assert (
        smartac3_auto_mode.current_humidity_timestamp
        == "2020-03-05T03:55:38.160Z"
    )
...
def test_smartac3_dry_mode():
    """Test smart ac cool mode."""
    smartac3_dry_mode = _mock_tado_climate_zone_from_fixture(
        "smartac3.dry_mode.json"
    )
    ...
    assert (
        smartac3_dry_mode.current_temp_timestamp == "2020-03-05T04:02:07.396Z"
    )
    ...
    assert (
        smartac3_dry_mode.current_humidity_timestamp
        == "2020-03-05T04:02:07.396Z"
    )
...
def test_smartac3_fan_mode():
    """Test smart ac cool mode."""
    smartac3_fan_mode = _mock_tado_climate_zone_from_fixture(
        "smartac3.fan_mode.json"
    )
    ...
    assert (
        smartac3_fan_mode.current_temp_timestamp == "2020-03-05T04:02:07.396Z"
    )
    ...
    assert (
        smartac3_fan_mode.current_humidity_timestamp
        == "2020-03-05T04:02:07.396Z"
    )
...
def test_smartac3_heat_mode():
    ...
    smartac3_heat_mode = _mock_tado_climate_zone_from_fixture(
        "smartac3.heat_mode.json"
    )
    ...
    assert (
        smartac3_heat_mode.current_temp_timestamp == "2020-03-05T03:57:38.850Z"
    )
    ...
    assert (
        smartac3_heat_mode.current_humidity_timestamp
        == "2020-03-05T03:57:38.850Z"
    )
...
def test_smartac3_with_swing():
    ...
    assert (
        smartac3_with_swing.current_temp_timestamp == "2020-03-28T02:09:27.830Z"
    )
    ...
    assert (
        smartac3_with_swing.current_humidity_timestamp
        == "2020-03-28T02:09:27.830Z"
    )
...
def test_smartac3_hvac_off():
    """Test smart ac cool mode."""
    smartac3_hvac_off = _mock_tado_climate_zone_from_fixture(
        "smartac3.hvac_off.json"
    )
    ...
    assert (
        smartac3_hvac_off.current_temp_timestamp == "2020-03-05T01:21:44.089Z"
    )
    ...
    assert (
        smartac3_hvac_off.current_humidity_timestamp
        == "2020-03-05T01:21:44.089Z"
    )
...
def test_smartac3_manual_off():
    ...
    assert (
        smartac3_manual_off.current_temp_timestamp == "2020-03-05T04:02:07.396Z"
    )
    ...
    assert (
        smartac3_manual_off.current_humidity_timestamp
        == "2020-03-05T04:02:07.396Z"
    )
...
def test_smartac3_offline():
    """Test smart ac cool mode."""
    smartac3_offline = _mock_tado_climate_zone_from_fixture(
        "smartac3.offline.json"
    )
    ...
    assert (
        smartac3_offline.current_humidity_timestamp
        == "2020-03-03T21:23:57.846Z"
    )
...
def test_hvac_action_heat():
    """Test smart ac cool mode."""
    hvac_action_heat = _mock_tado_climate_zone_from_fixture(
        "hvac_action_heat.json"
    )
    ...
    assert (
        hvac_action_heat.current_humidity_timestamp
        == "2020-03-06T18:06:09.546Z"
    )
...
def test_smartac3_turning_off():
    ...
    assert (
        smartac3_turning_off.current_temp_timestamp
        == "2020-03-06T19:06:13.185Z"
    )
    ...
    assert (
        smartac3_turning_off.current_humidity_timestamp
        == "2020-03-06T19:06:13.185Z"
    )
...
def test_tadov2_heating_manual_mode():
    ...
    mode = _mock_tado_climate_zone_from_fixture(
        "tadov2.heating.manual_mode.json"
    )
    assert mode.preparation is False
    assert mode.open_window is False
    assert mode.open_window_attr == {}
...
def test_tadov2_water_heater_auto_mode():
    ...
    mode = _mock_tado_climate_zone_from_fixture(
        "tadov2.water_heater.auto_mode.json"
    )
    assert mode.preparation is False
    assert mode.open_window is False
    assert mode.open_window_attr == {}
...
def test_tadov2_water_heater_manual_mode():
    ...
    mode = _mock_tado_climate_zone_from_fixture(
        "tadov2.water_heater.manual_mode.json"
    )
    assert mode.preparation is False
    assert mode.open_window is False
    assert mode.open_window_attr == {}
...
def test_tadov2_water_heater_off_mode():
    ...
    mode = _mock_tado_climate_zone_from_fixture(
        "tadov2.water_heater.off_mode.json"
    )
    assert mode.preparation is False
    assert mode.open_window is False
    assert mode.open_window_attr == {}
