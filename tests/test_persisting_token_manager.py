...
from PyTado.token_manager.persisting_token_manager import PersistingTokenManager

from . import common


class TestPersistingTokenManager(unittest.TestCase):
    ...
    def test_save_refresh_token(self):
        ...
        with mock.patch("builtins.open", mock_open) as mock_file:
            token_manager = PersistingTokenManager(token_file_path="path/to/open")
